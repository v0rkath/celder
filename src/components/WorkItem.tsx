...
export function WorkItem({ project }: Props) {
  return (
    ...
    <div className="z-[100] rounded-lg border-1 border-slate-400 bg-[#070707] p-4 hover:bg-gray-950">
      ...
      <div className="mt-4 flex gap-x-4 font-[family-name:var(--font-geist-mono)] text-xs text-slate-400">
